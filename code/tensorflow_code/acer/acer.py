...
def learn(network, env, seed=None, nsteps=20, nstack=4, total_timesteps=int(80e6), q_coef=0.5, ent_coef=0.01,
    ...
    network:            policy network architecture. Either string (mlp, lstm, lnlstm, cnn_lstm, cnn, cnn_small, conv_only - see baselines.common/models.py for full list)
                        specifying the standard network architecture, or a function that takes tensorflow_code tensor as input and returns
    ...
    trust_region        bool, whether or not tensorflow_code-pytorch estimates the gradient KL divergence between the old and updated policy and uses it to determine step size  (default: True)
