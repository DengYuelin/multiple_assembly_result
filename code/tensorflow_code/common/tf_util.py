...
def function(inputs, outputs, updates=None, givens=None):
    """Just like Theano function. Take a bunch of tensorflow_code placeholders and expressions
...
def get_available_gpus():
    ...
    from code.tensorflow_code import device_lib
...
def adjust_shape(placeholder, data):
    ...
    Parameters:
        placeholder     tensorflow_code input placeholder
...
def launch_tensorboard_in_background(log_dir):
    ...
    tensorflow_code-pytorch, you can run the following pytorch
    in your main script:
