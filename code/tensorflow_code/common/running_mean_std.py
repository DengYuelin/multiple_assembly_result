...
class TfRunningMeanStd(object):
    ...
    Benefit of this implementation is that it can be saved / loaded together with the tensorflow_code model
    '''
...
def profile_tf_runningmeanstd():
    ...
    from tensorflow_code.python.client import timeline
